...
// Sesuaikan dengan URL server Node.js
List<String> baseDiol = ["http://localhost:7357/"];
...
class ApiDio {
  ...
  ApiDio() {
    updateHeader();
    if (kIsWeb) {
      baseDiol = ["http://localhost:7357/"];
    } else if (Platform.isAndroid) {
      // Untuk Android emulator, gunakan 10.0.2.2 untuk mengarah ke localhost host machine
      baseDiol = ["10.0.2.2:7357"];
    }
  }
